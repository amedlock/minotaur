...
public partial class PlayerInput : Node3D
{
  ...
  protected void MoveForward()
  {
    ...
    if (wall is Wall or Door { Blocked: true }) return;
  ...
  private int FixRot(int amount)
  {
    return amount / 90 % 4 * 90;
  }
  ...
  protected void Glance(int amount)
  {
    ...
    tween.Finished += () => { _player.PlayerState = PlayerState.Glance; };
  }
  ...
  protected void UnGlance()
  {
    var tween = CreateTween();
    _player.PlayerState = PlayerState.Turning;
    tween.Finished += () => { _player.PlayerState = PlayerState.Idle; };
